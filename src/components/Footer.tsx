      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li>Email: <a href="mailto:info@haprixai.com" className="font-medium text-gradient-gold hover:opacity-80 transition-opacity underline-offset-4 hover:underline">info@haprixai.com</a></li>
